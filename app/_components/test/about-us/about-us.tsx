...
export const AboutUs = () => {
	...
	return (
		<section
			ref={containerRef}
			id="about-us"
			className="relative flex h-auto w-full flex-col items-center justify-center space-y-10 bg-lush-white px-2 pt-20 lg:px-0">
			<div className="space-y-2 md:w-4/5 lg:w-1/2">
				<h1 className="text--scroll text-center text-4xl capitalize">
					{_Text.heading}
				</h1>
				<MappingWrapper
					array={_Text.main}
					render={(paragraph, index) => (
						<p key={index} className="text--scroll text-justify indent-6">
							{paragraph}
						</p>
					)}
				/>
			...
			<div id="gallery" className="space-y-5">
				<h1 className="lg: px-2 text-4xl lg:px-5">Gallery</h1>
